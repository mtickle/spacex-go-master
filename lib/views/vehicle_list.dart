...
class VehicleList extends StatelessWidget {
  ...
  Future fetchVehicles(BuildContext context) async {
    ...
    vehicleList.addAll(capsulesJson.map((capsule) => CapsuleInfo.fromJson(capsule)).toList());
    vehicleList.addAll(rocketsJson.map((rocket) => RocketInfo.fromJson(rocket)).toList());
    vehicleList.addAll(shipsJson.map((rocket) => ShipInfo.fromJson(rocket)).toList());
